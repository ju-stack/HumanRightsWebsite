      ...
      <div style={{textAlign: "center"}}>
        ...
        <div style={{display : "flex", alignItems : "center", margin:"0 auto", width: "min-content"}}>
            ...
            <div style={{display:"inline", width:"30vw", height:"auto", margin:"2vw"}}>
              <span style={{color:"green", fontWeight:"bold"}}>교권</span> 추락에 대한 <span style={{color:"red", fontWeight:"bold"}}>경고</span>와 <span style={{color:"blue", fontWeight:"bold"}}>존중</span>의 의미를 가진 포스터이다.
            </div>
        </div>
      </div>
    );
